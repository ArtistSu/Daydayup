...
/**
 * 1. trait can include abstract and non-abstract members, this is
 * similar to abstract class in Scala. But you don't need to use
 * abstract keyword.
 * 2. If you want to override the method in trait, you don't need
 * to use override keyword.
 * 3. You should use extend keyword no matter you extend to Trait
 * or Abstract class.
 * 4. If you extend a trait with any abstract members, you must
 * implement them or override them.
 * 5. If you want to extends more class, you must extends first
 * one and use with keyword for the others. e.g.
 * class_t1 extends t2 with t3 with t4
